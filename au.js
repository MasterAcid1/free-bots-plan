...
class Client {
    ...
    loadGUI() {
        ...
        <input onchange="localStorage.setItem('botNick', this.value);" id="" maxlength="15" class="form-control" placeholder="Bot Name" value="KrunkerDarezYT"></input>
        ...
        <input onchange="localStorage.setItem('botAmount', this.value);" id="BotAmount" maxlength="3" class="form-control" placeholder="Bot Amount" value="15"></input>
    ...
    startBots(amount) {
        ...
        amount > 15 ? amount = 15 : amount = amount;
